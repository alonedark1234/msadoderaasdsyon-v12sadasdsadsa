...
module.exports = {
  ...
  onRequest: async function (client, message, args) {
    ...
    let embed = new MessageEmbed().setColor('0x2f3136').setTitle(`Kalkmazban (v2.0)`).setAuthor(passenger.Tag + " " + passenger.sunucuIsmi, message.guild.iconURL({dynamic: true, size: 2048}))
